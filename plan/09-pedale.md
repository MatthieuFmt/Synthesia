...
> Statut : **complet** (30/07/2026) — Pédale directe, Pédale syncopée et
> **Application**, trois niveaux de difficulté, un vrai petit morceau joué et
> deux repères visuels qui disent **quand** agir. La famille Écoute a été
> retirée le 27/07 ; la famille Application, longtemps bloquée faute d'un seul
> fichier pédalé dans le dépôt, est faite depuis que les exercices générés en
> produisent trois ([§ 20](#20-famille-application--faite-le-30072026)). Voir la
